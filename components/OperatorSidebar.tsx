...
const DriversIcon = () => <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>;
        ...
        <aside className="w-64 bg-white shadow-md flex-shrink-0 hidden lg:block">
            <div className="p-6">
                ...
                <nav className="space-y-2">
                    ...
                    <NavItem icon={<DriversIcon />} label="Drivers" page="OPERATOR_DRIVERS" />
